...
let vlevo = document.getElementById("vlevo");
let vpravo = document.getElementById("vpravo");
let vysledek;
let naparsovanoVlevo;
let naparsovanoVpravo;

/* let requestURLEur = "https://api.exchangerate.host/latest?symbols=CZK";
let requestEur = new XMLHttpRequest();
requestEur.open("GET", requestURLEur);
requestEur.responseType = "json";
requestEur.send();

requestEur.onload = function () {
  let responseEur = requestEur.response;
  console.log(responseEur);
};

let requestURLUsd = "https://api.exchangerate.host/latest?base=USD&symbols=CZK";
...
requestUsd.onload = function () {
  let responseUsd = requestUsd.response;
...
btnDelka.onclick = function () {
  ...
  slctHmotnost.style.display = "null";
  slctObjem.style.display = "null";
  slctObsah.style.display = "null";
  slctRychlost.style.display = "null";
  slctTeplota.style.display = "null";
  slctMena.style.display = "null";
